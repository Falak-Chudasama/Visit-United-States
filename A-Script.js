...
// section-2
function nycPage() {
    window.location.href = 'C-NYC.html';
}
function laPage() {
    window.location.href = 'C-LA.html';
}
function miamiPage() {
    window.location.href = 'C-Miami.html';
}
function chicagoPage() {
    window.location.href = 'C-Chicago.html';
}
function lasVegasPage() {
    window.location.href = 'C-LasVegas.html';
}
function sanFraciscoPage() {
    window.location.href = 'C-SanFrancisco.html';
}

// section 3

function visaInfoPage() {
    window.location.href = 'D-VisaInfo.html';
}
function explorePage() {
    window.location.href = 'D-Explore.html';
}
function tipsPage() {
    window.location.href = 'D-Tips.html';
}
function transportPage() {
    window.location.href = 'D-Transportation.html';
}

// section 4
function historicalLandmarkPage() {
    window.location.href = 'E-HistoricalLandmarks.html';
}
function coastalDestinationsPage() {
    window.location.href = 'E-CoastalDestinations.html';
}
function outdoorAdventuresPage() {
    window.location.href = 'E-OutdoorAdventures.html';
}
function roadTripsPage() {
    window.location.href = 'E-RoadTrips.html';
}
function metroCitiesPage() {
    window.location.href = 'E-MetropolitanCities.html';
}
function themeParkPage() {
    window.location.href = 'E-ThemeParks.html';
}
function foodPage() {
    window.location.href = 'E-Food.html';
}
function festivalsPage() {
    window.location.href = 'E-FestivalsEvents.html';
}
function sportsPage() {
    window.location.href = 'E-SportsEvents.html';
}